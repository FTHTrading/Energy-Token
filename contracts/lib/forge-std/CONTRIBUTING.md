...
Specific performance optimization techniques, coding styles and conventions change over time. The first impression you give to a new contributor never goes away.

If you ask for changes, explain why the requested change is better than the original. If possible, link to the Foundry book, Rust documentation, or other relevant documentation.

When you suggest changes, try to suggest them as optional improvements rather than requirements.

##### Be aware of the scope

Often, a pull request will be doing more than one thing. It is helpful to understand the scope of the PR and to separate the review into logical chunks. For example, if a PR is adding a new feature and also fixing a bug, review the bug fix separately from the feature.

##### Be timely

If you are able to review a pull request, please do so in a timely manner. If you are unable to review, please let the contributor know so they can find someone else.

##### Not all feedback requires action

It is fine to leave comments on a pull request without requesting changes. For example, you might leave a comment saying "Nice!" or "I learned something from this." These comments are valuable and help build community.

### Thank you

Thank you for contributing to Foundry!

[dev-tg]: https://t.me/foundry_dev
